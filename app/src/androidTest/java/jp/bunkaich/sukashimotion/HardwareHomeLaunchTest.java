...
public class HardwareHomeLaunchTest {
    ...
    @Test public void realInnerHomeLaunchesSelectedAppsAndKeepsLongPress() throws Exception {
        Assume.assumeTrue("true".equals(InstrumentationRegistry.getArguments().getString("folduoHardware")) && (DeviceSupport.isFold7(Build.MODEL)||DeviceSupport.isFold8(Build.MODEL)));
